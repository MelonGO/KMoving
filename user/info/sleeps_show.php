...
<div class="container-fluid user-info">
    <div class="row">
        <div class="col-md-12">
            <ul class="pager">
                <li class="previous"><a href="http://www.kmoving.com/date_change.php?item=sleeps&info=previous">&larr; Previous</a></li>
                <li id="date"><?php echo $_COOKIE["date"]?></li>
                <li class="next"><a href="http://www.kmoving.com/date_change.php?item=sleeps&info=next">Next &rarr;</a></li>
            </ul>
        </div>
        <div class="col-md-12">
            <ol class="breadcrumb">
            ...
            <?php
            include("../../server/user/sleeps.php");
            ?>
        </div>
    </div>
</div>
